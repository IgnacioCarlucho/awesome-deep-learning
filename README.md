...
2.  [Scikit Flow - Simplified interface for TensorFlow (mimicking Scikit Learn)](https://github.com/google/skflow)
3.  [Keras - High layer for tensorflow](https://keras.io/)
4.  [TFLearn - API for tensoflow, but has more control than keras](http://tflearn.org/)
